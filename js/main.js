...
function Effect1512() {
    ...
    this.scaling = (c, t) => {
        return [0, 4 * t.filter(e => e.species === "Génie").length, 0, 0];
    };
    this.battleValue = (c, t) => {
        return 0;
    };
...
function Effect1513() {
    ...
    this.scaling = (c, t) => {
        return [0, 1.25 * t.filter(e => e.species === "Génie").length, 0, 0];
    };
    this.battleValue = (c, t) => {
        return 0;
    };
...
function Effect1517() {
    ...
    this.scaling = (c, t) => {
        return [0, 2.25 * t.filter(e => e.species === "Génie").length, 0, 0];
    };
    this.battleValue = (c, t) => {
        return 0;
    };
...
function Effect1614() {
    ...
    this.battleValue = (c, t) => {
        return 4 * t.filter(e => e.species === "Fae").length;
    };
    this.toFront = true;
